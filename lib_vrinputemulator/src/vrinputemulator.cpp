...
void VRInputEmulator::enableStepDetection(bool enable, bool modal) {
	if (_ipcServerQueue) {
...
void VRInputEmulator::useEulerForStep(bool enable, bool modal) {
	if (_ipcServerQueue) {
		ipc::Request message(ipc::RequestType::DeviceManipulation_StepDetectionMode);
		memset(&message.msg, 0, sizeof(message.msg));
		message.msg.dm_StepDetectionMode.clientId = m_clientId;
		message.msg.dm_StepDetectionMode.messageId = 0;
		message.msg.dm_StepDetectionMode.useEulerForStep = enable ? 1 : 2;
...
void VRInputEmulator::setStepAcceleration(float value, bool modal) {
	if (_ipcServerQueue) {
		ipc::Request message(ipc::RequestType::DeviceManipulation_StepDetectionMode);
		memset(&message.msg, 0, sizeof(message.msg));
		message.msg.dm_StepDetectionMode.clientId = m_clientId;
		message.msg.dm_StepDetectionMode.messageId = 0;
		message.msg.dm_StepDetectionMode.stepAcceleration = value;
...
void VRInputEmulator::setStepSpeed(float value, bool modal) {
	if (_ipcServerQueue) {
		ipc::Request message(ipc::RequestType::DeviceManipulation_StepDetectionMode);
		memset(&message.msg, 0, sizeof(message.msg));
		message.msg.dm_StepDetectionMode.clientId = m_clientId;
		message.msg.dm_StepDetectionMode.messageId = 0;
		message.msg.dm_StepDetectionMode.stepSpeed = value;
		message.msg.dm_StepDetectionMode.stepDetectOperation = 3;
		if (modal) {
			uint32_t messageId = _ipcRandomDist(_ipcRandomDevice);
			message.msg.dm_DeviceOffsets.messageId = messageId;
			std::promise<ipc::Reply> respPromise;
...
void VRInputEmulator::setStepIntSec(float value, bool modal) {
	if (_ipcServerQueue) {
		ipc::Request message(ipc::RequestType::DeviceManipulation_StepDetectionMode);
		memset(&message.msg, 0, sizeof(message.msg));
		message.msg.dm_StepDetectionMode.clientId = m_clientId;
...
void VRInputEmulator::setHMDThreshold(const vr::HmdVector3d_t & value, bool modal) {
	if (_ipcServerQueue) {
		ipc::Request message(ipc::RequestType::DeviceManipulation_StepDetectionMode);
		memset(&message.msg, 0, sizeof(message.msg));
		message.msg.dm_StepDetectionMode.clientId = m_clientId;
...
void VRInputEmulator::setHandThreshold(const vr::HmdVector3d_t & value, bool modal) {
	if (_ipcServerQueue) {
		ipc::Request message(ipc::RequestType::DeviceManipulation_StepDetectionMode);
		memset(&message.msg, 0, sizeof(message.msg));
		message.msg.dm_StepDetectionMode.clientId = m_clientId;
		message.msg.dm_StepDetectionMode.messageId = 0;
		message.msg.dm_StepDetectionMode.handThreshold = value;
