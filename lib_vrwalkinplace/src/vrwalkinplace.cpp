...
namespace vrwalkinplace {
	...
	void VRWalkInPlace::setAccuracyButtonAsToggle(bool val, bool modal) {
		if (_ipcServerQueue) {
			ipc::Request message(ipc::RequestType::WalkInPlace_StepDetectionMode);
			memset(&message.msg, 0, sizeof(message.msg));
			message.msg.dm_StepDetectionMode.clientId = m_clientId;
			message.msg.dm_StepDetectionMode.messageId = 0;
			message.msg.dm_StepDetectionMode.useButtonAsToggle = val;
	...
	void VRWalkInPlace::setAccuracyButtonFlip(bool val, bool modal) {
		if (_ipcServerQueue) {
			ipc::Request message(ipc::RequestType::WalkInPlace_StepDetectionMode);
			memset(&message.msg, 0, sizeof(message.msg));
			message.msg.dm_StepDetectionMode.clientId = m_clientId;
			message.msg.dm_StepDetectionMode.messageId = 0;
			message.msg.dm_StepDetectionMode.flipButtonUse = val;
